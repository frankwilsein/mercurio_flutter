...
class DisplayPolylinesEvent2 extends MapEvent {
  ...
  const DisplayPolylinesEvent2(this.polylines, this.markers);
}
class DisplayPolylinesEvent3 extends MapEvent {
  final Map<String, Polyline> polylines;
    final Map<String, Marker> markers;

  const DisplayPolylinesEvent3(this.polylines, this.markers);
}