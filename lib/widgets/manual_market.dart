...
StateError (Bad state: add(DisplayPolylinesEvent) was called without a registered event handler.
Make sure to register a handler via on<DisplayPolylinesEvent>((event, emit) {...}))*/
